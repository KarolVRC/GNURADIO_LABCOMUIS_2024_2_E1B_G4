...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_win = qtgui.RangeWidget(self._fm_range, self.set_fm, "Frecuenca del mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ka_win = qtgui.RangeWidget(self._Ka_range, self.set_Ka, "Coeficiene ka", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Ka_win)
        self._GTX_range = qtgui.Range(0, 30, 1, 0, 200)
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganacia de transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "AMplid portadoa Ac", "counter_slider", float, QtCore.Qt.Horizontal)
